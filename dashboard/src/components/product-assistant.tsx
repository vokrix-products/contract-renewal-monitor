...
const PRODUCT_NAME = import.meta.env.VITE_PRODUCT_NAME ?? 'this product'
const PRODUCT_DESCRIPTION = import.meta.env.VITE_PRODUCT_DESCRIPTION ?? ''
const ASSISTANT_CONTEXT = import.meta.env.VITE_ASSISTANT_CONTEXT ?? ''
...
export function ProductAssistant() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-6 right-6 z-50 w-80 sm:w-96 h-[480px] rounded-xl border border-border bg-card shadow-xl flex flex-col overflow-hidden">
